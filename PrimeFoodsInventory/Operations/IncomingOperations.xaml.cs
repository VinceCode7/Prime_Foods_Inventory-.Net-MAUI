...
public partial class IncomingOperations : ContentPage
{
	public IncomingOperations()
	{
		InitializeComponent();
	}
    ...
    private async Task ItemsInventoryAsync()
    {
        ...
        try
        {
            ...
            string retrieveQuery3 = "SELECT ItemName,ItemCategory,Quantity,UnitOfMeasurement,SupplierName,ItemPrice,DateRecorded FROM InventoryIncoming WHERE DateRecorded BETWEEN @StartDate AND @EndDate;";
